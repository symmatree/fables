...
| Path | Summary | Link |
|------|---------|------|
| `Drones/rekon10/README.md` | Index of all Rekon 10 Pro topic documents with one-line descriptions | [README.md](https://github.com/symmatree/fables/blob/main/Drones/rekon10/README.md) |
| `Drones/rekon10/rekon-design.md` | System-level design: mission goals (forestry/property 3D mapping under canopy), navigation architecture (GNSS + VIO), mapping payload architecture (synchronized multi-camera array) | [rekon-design.md](https://github.com/symmatree/fables/blob/main/Drones/rekon10/rekon-design.md) |
| `Drones/rekon10/canopy-ops.md` | Under-canopy operations doctrine: ice-hole GPS re-acquisition pattern, gap detection, two separate error budgets (flight safety vs. post-processing) | [canopy-ops.md](https://github.com/symmatree/fables/blob/main/Drones/rekon10/canopy-ops.md) |
| `Drones/rekon10/arm-pods.md` | Arm pod hardware: Pi Zero 2 W + Camera Module 3 pods, multicamera sync, DS3234 PPS distribution, chrony, upward gap-detect camera pair | [arm-pods.md](https://github.com/symmatree/fables/blob/main/Drones/rekon10/arm-pods.md) |
| `Drones/rekon10/mapping.md` | Post-processing pipeline: PPK timestamp interpolation, ODM, rolling-shutter correction, under-canopy product considerations | [mapping.md](https://github.com/symmatree/fables/blob/main/Drones/rekon10/mapping.md) |
| `Drones/rekon10/ardupilot.md` | ArduPilot configuration: parameters, serial assignments, RC setup, tooling | [ardupilot.md](https://github.com/symmatree/fables/blob/main/Drones/rekon10/ardupilot.md) |
| `Drones/rekon10/flight-platform.md` | As-built hardware, wiring, and component stack | [flight-platform.md](https://github.com/symmatree/fables/blob/main/Drones/rekon10/flight-platform.md) |
| `Drones/rekon10/flight-platform-build-log.md` | Chronological build log and bench notes | [flight-platform-build-log.md](https://github.com/symmatree/fables/blob/main/Drones/rekon10/flight-platform-build-log.md) |
| `Drones/rekon10/central-hub.md` | Central hub: power distribution, pod harness, Coordinator integration | [central-hub.md](https://github.com/symmatree/fables/blob/main/Drones/rekon10/central-hub.md) |
| `Drones/rekon10/oak-d-mount.md` | OAK-D stereo+IMU forehead mount for VIO in GPS-degraded flight | [oak-d-mount.md](https://github.com/symmatree/fables/blob/main/Drones/rekon10/oak-d-mount.md) |
| `Drones/rekon10/ground-station.md` | Ground equipment: radio (EdgeTX Boxer), goggles, base-station setup | [ground-station.md](https://github.com/symmatree/fables/blob/main/Drones/rekon10/ground-station.md) |
