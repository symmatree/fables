...
> **Update (2026-07-30):** a read of the backpack firmware source supports the Mission-Planner-contention side and folds both hypotheses into one -- still unconfirmed (no GCS caught red-handed). Consolidated, with the diagnostic to run next time: coordinator [`docs/rtk-corrections-path.md`](https://github.com/symmatree/coordinator/blob/main/docs/rtk-corrections-path.md), [coordinator#99](https://github.com/symmatree/coordinator/issues/99).
