...
V1 printed 06-27 (date showed 05 from last edit). All hole spacings good, but drone mounting plate swapped front to back (one set is 1mm closer than the other set, but I had them swapped).
