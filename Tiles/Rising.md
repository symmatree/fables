...
**Deployment:** Talos USB install and cluster operations: tiles repo `docs/bare-metal-nodes.md` (Operations). A commented `metal_amd_nodes` example for this machine is in tiles `tf/nodes/prod.tfvars`. BIOS, MAC, and fixed IP stay in this note.
