...
| 2026-05-06 | Operator | Workstream 3 note: k8s-monitoring single Alloy path, alloy-mixin + cert-manager-mixin Argo apps (Tanka symlink pattern), `job=integrations/alloy`, `cluster_name` checks, CMP stall then green; see **`tiles/docs/argocd-cmp-stalls-investigation.md`**. |
