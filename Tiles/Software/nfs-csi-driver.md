...
- **TF / bootstrap values**: Yes. Variables used: nfs_server, cluster_nfs_path. No dedicated .tf for this component; values from app-of-apps. TF: [k8s-cluster](https://github.com/symmatree/tiles/blob/main/tf/modules/k8s-cluster).
...
No dedicated .tf; bootstrap values from app-of-apps (see **Configuration** above). The NFS server and shares are managed separately on the Synology NAS.
